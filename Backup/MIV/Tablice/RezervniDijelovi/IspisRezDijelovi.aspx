<%@ Page Title="" Language="C#" MasterPageFile="~/Glavna.Master" AutoEventWireup="true" CodeBehind="IspisRezDijelovi.aspx.cs" Inherits="MIV.Tablice.RezervniDijelovi.IspisRezDijelovi" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<link href="rezdijelovi.css" rel="stylesheet" type="text/css" media="all" />
...
<div>
        <asp:Label ID="Label4" CssClass="PNaslovi" runat="server" Text="Rezervni dijelovi"></asp:Label>
        <br />
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            CellPadding="4" DataSourceID="SqlDataSourceRezDijelovi" 
            ForeColor="#333333" CssClass="mGrid"  PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" DataKeyNames="ID">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="REZERVNI DIJELOVI" 
                    SortExpression="REZERVNI DIJELOVI">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox1" runat="server" 
                            Text='<%# Bind("[REZERVNI DIJELOVI]") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("[REZERVNI DIJELOVI]") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:SqlDataSource ID="SqlDataSourceRezDijelovi" runat="server" 
            ConnectionString="<%$ ConnectionStrings:MIV %>" 
            SelectCommand="SELECT * FROM [RezervniDijelovi]"></asp:SqlDataSource>
        <asp:Button ID="botton" runat="server" onclick="botton_Click" Text="Završi" 
            CssClass="myButton" />
        <br />
        <asp:HyperLink ID="UrediRezMat" runat="server" 
            NavigateUrl="~/Zaposlenici/UrediRezDijelovi.aspx">Uredi Rezervne Dijelove</asp:HyperLink>
    </div>
</asp:Content>
